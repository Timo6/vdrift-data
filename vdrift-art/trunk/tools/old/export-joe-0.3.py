	...
	for frame_counter in range(0,joe.num_frames):
		...
		for this_face in xrange(0, joe.num_faces):
			...
			if not mesh.faces[this_face].smooth:
				...
				#print "smooth: ",facenorms[this_face].normals[0].vertex
...
# Import globals
g_filename=Create("/home/thelusiv/games/vdrift-branches/new-tracks/data/cars/s2000/collision.joe")
